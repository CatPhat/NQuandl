...
//    {
//        private readonly IParseFromCSV _parseFromCSV;
//        public ParseCSVToModel(IParseFromCSV parseFromCSV)
//        {
//            _parseFromCSV = parseFromCSV;
//        }

//        public IEnumerable<QuandlCSVModel> GetCSVModelsFromCSVFile(string csvFilePath)
//        {
...
//        private IEnumerable<QuandlCSVModel> GetCSVModelFromCSVRows(IEnumerable<string[]> CSVRows)
//        {
...
//                }
//                else if (header.Equals("code", StringComparison.InvariantCultureIgnoreCase) || header.Equals("quandl code", StringComparison.InvariantCultureIgnoreCase))
//                {
...
//        private IEnumerable<QuandlCSVModel> GetQuandlCodeForStocks(IEnumerable<string[]> CSVRows)
//        {
